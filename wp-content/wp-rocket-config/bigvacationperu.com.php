...
$rocket_cookie_hash = '2f3d4f8e8c547a0df141ceba348d2ac0';
$rocket_logged_in_cookie = 'wordpress_logged_in_2f3d4f8e8c547a0df141ceba348d2ac0';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_mobile = 1;
$rocket_do_caching_mobile_files = 1;
$rocket_cache_reject_uri = '/(.+/)?feed/?.+/?|/(?:.+/)?embed/|/checkout/(.*)|/cart/|/login/(.*)|/wc-api/v(.*)|/(index\.php/)?wp\-json(/.*|$)';
...
$rocket_secret_cache_key = '5faafa1391e3f700062524';
$rocket_cache_ssl = 1;
