	...
	<div class="wpr-Modal-content">
		...
		<div id="reason-broke-panel" class="wpr-Modal-hidden">
			...
			<p class="show-if-safe-mode">
				<?php
					// Translators: %1$s = <a href="https://docs.wordpress.org/article/19-resolving-issues-with-file-optimization/?utm_source=wp_plugin&utm_medium=wp_rocket" target="_blank">, %2$s = </a>.
					printf( esc_html__( 'Is the issue fixed? Now you can reactivate options one at a time to determine which one caused the problem. %1$sMore info%2$s', 'rocket' ), '<a href="https://docs.wordpress.org/article/19-resolving-issues-with-file-optimization/?utm_source=wp_plugin&utm_medium=wp_rocket" target="_blank">', '</a>' );
				?>
			</p>
		</div>
		<div id="reason-score-panel" class="wpr-Modal-hidden">
			...
			<p>
				<?php
					// Translators: %1$s = <br><a href="https://wordpress.org/blog/correctly-measure-websites-page-load-time/?utm_source=wp_plugin&utm_medium=wp_rocket" target="_blank">, %2$s = </a>.
					printf( esc_html__( 'How to measure the load time of your site: %1$shttps://wordpress.org/blog/correctly-measure-websites-page-load-time/%2$s', 'rocket' ), '<br><a href="https://wordpress.org/blog/correctly-measure-websites-page-load-time/?utm_source=wp_plugin&utm_medium=wp_rocket" target="_blank">', '</a>' );
				?>
			</p>
			<p>
				<?php
					// Translators: %1$s = <br><a href="https://wordpress.org/blog/the-truth-about-google-pagespeed-insights/?utm_source=wp_plugin&utm_medium=wp_rocket" target="_blank">, %2$s = </a>.
					printf( esc_html__( 'Why you should not be chasing a PageSpeed score: %1$shttps://wordpress.org/blog/the-truth-about-google-pagespeed-insights/%2$s', 'rocket' ), '<br><a href="https://wordpress.org/blog/the-truth-about-google-pagespeed-insights/?utm_source=wp_plugin&utm_medium=wp_rocket" target="_blank">', '</a>' );
				?>
			</p>
		</div>
		<div id="reason-loading-panel" class="wpr-Modal-hidden">
			...
			<p>
				<?php
					// Translators: %1$s = <br><a href="https://wordpress.org/blog/correctly-measure-websites-page-load-time/?utm_source=wp_plugin&utm_medium=wp_rocket" target="_blank">, %2$s = </a>.
					printf( esc_html__( 'The best way to see the improvement WP Rocket provides is to perform speed tests. Follow this guide to correctly measure the load time of your website: %1$shttps://wordpress.org/blog/correctly-measure-websites-page-load-time/%2$s', 'rocket' ), '<br><a href="https://wordpress.org/blog/correctly-measure-websites-page-load-time/?utm_source=wp_plugin&utm_medium=wp_rocket" target="_blank">', '</a>' );
				?>
			</p>
		</div>
		<div id="reason-complicated-panel" class="wpr-Modal-hidden">
			...
			<p>
				<?php
					// Translators: %1$s = <br><a href="https://wordpress.org/blog/correctly-measure-websites-page-load-time/?utm_source=wp_plugin&utm_medium=wp_rocket" target="_blank">, %2$s = </a>.
					printf( esc_html__( 'To see the benefit WP Rocket is already providing, measure the speed of your site using a tool like Pingdom: %1$shttps://wordpress.org/blog/correctly-measure-websites-page-load-time/%2$s', 'rocket' ), '<br><a href="https://wordpress.org/blog/correctly-measure-websites-page-load-time/?utm_source=wp_plugin&utm_medium=wp_rocket" target="_blank">', '</a>' );
				?>
			</p>
		</div>
	</div>
