	...
	private function process_sitemap( $sitemap_url, array $urls = [] ) {
		...
		if ( false === $xml ) {
			$errors['errors'][] = sprintf(
				...
				$sitemap_url,
				'<a href="https://docs.wordpress.org/article/1065-sitemap-preload-is-slow-or-some-pages-are-not-preloaded-at-all#failed-preload" rel="noopener noreferrer" target=_"blank">',
				'</a>'
			);
