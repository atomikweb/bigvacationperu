...
class Detect_Missing_Tags_Subscriber implements Subscriber_Interface {
	...
	public function rocket_notice_missing_tags() {
		...
		$msg .= ' ' . sprintf(
			...
			'<a href="' . esc_url( __( 'https://docs.wordpress.org/article/99-pages-not-cached-or-minify-cssjs-not-working/?utm_source=wp_plugin&utm_medium=wp_rocket#theme', 'rocket' ) ) . '" rel="noopener noreferrer" target="_blank">',
			'</a>'
		);
